...
%        pp.ti          % desired frame increment [0.004 seconds]
...
%        IEEE Trans Speech Audio Processing, 2 (2): 345?49, Apr. 1994. doi: 10.1109/89.279283.
...
%        Speech Communication, 49: 530?41, 2007. doi: 10.1016/j.specom.2006.06.012.
...
if isstruct(fsz)
    ...
    qq.ti=16e-3;    % desired frame increment (4 ms)
